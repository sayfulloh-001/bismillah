        ...
        <div className="container">
          ...
          {view === 'home' && (
            <>
              ...
              {/* FOUNDERS & LEAD ENGINEERS SECTION */}
              <section style={{ margin: '3.5rem 0 5rem 0' }}>
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                  <div style={{
                    ...
                    <Sparkles size={14} /> PLATFORMA ASOSCHILARI
                  </div>
                  <h2 style={{ fontSize: '2.2rem', fontWeight: 800, marginBottom: '0.5rem' }}>
                    Loyihamiz Asoschilari va Bosh Muhandislari
                  </h2>
                  <p style={{ color: 'var(--text-secondary)', maxWidth: '650px', margin: '0 auto', fontSize: '0.95rem' }}>
                    Freelancer Hub Uz platformasiga asos solgan va tizim arxitekturasini ishlab chiqqan yetakchi muhandislar.
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  {/* Founder 1: Software Engineer (Domla) */}
                  <div className="glass-card" style={{
                    background: 'linear-gradient(145deg, rgba(14, 18, 36, 0.92) 0%, rgba(6, 9, 20, 0.96) 100%)',
                    border: '1px solid rgba(168, 85, 247, 0.35)',
                    borderRadius: '24px',
                    padding: '2rem 1.5rem',
                    textAlign: 'center',
                    position: 'relative',
                    boxShadow: '0 15px 35px rgba(0, 0, 0, 0.6), 0 0 25px rgba(168, 85, 247, 0.2)'
                  }}>
                    <div style={{ position: 'relative', width: '125px', height: '125px', margin: '0 auto 1.25rem auto' }}>
                      <img 
                        src="/founder-engineer.png" 
                        alt="Software Engineer (Domla)" 
                        style={{
                          width: '100%',
                          height: '100%',
                          borderRadius: '50%',
                    ...
                    <div style={{ display: 'inline-block', background: 'rgba(168, 85, 247, 0.18)', border: '1px solid rgba(168, 85, 247, 0.4)', color: '#c084fc', padding: '0.2rem 0.75rem', borderRadius: '15px', fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', marginBottom: '0.75rem' }}>
                      Asoschi & Software Engineer
                    </div>
                    ...
                    <button 
                      onClick={() => handleOpenBuyurmaForm()}
                      className="btn btn-primary"
                      style={{ width: '100%', padding: '0.65rem 1.25rem', fontSize: '0.88rem' }}
                    >
                      <Rocket size={15} /> Bog'lanish / Loyiha berish
                    </button>
                  </div>

                  {/* Founder 2: Full Stack Developer */}
                  <div className="glass-card" style={{
                    background: 'linear-gradient(145deg, rgba(14, 18, 36, 0.92) 0%, rgba(6, 9, 20, 0.96) 100%)',
                    ...
                    textAlign: 'center',
                    position: 'relative',
                    boxShadow: '0 15px 35px rgba(0, 0, 0, 0.6), 0 0 25px rgba(56, 189, 248, 0.2)'
                  }}>
                    <div style={{ position: 'relative', width: '125px', height: '125px', margin: '0 auto 1.25rem auto' }}>
                      <img 
                    ...
                    <div style={{ display: 'inline-block', background: 'rgba(56, 189, 248, 0.18)', border: '1px solid rgba(56, 189, 248, 0.4)', color: '#38bdf8', padding: '0.2rem 0.75rem', borderRadius: '15px', fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', marginBottom: '0.75rem' }}>
                      Asoschi & Full Stack Developer
                    </div>
                    ...
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', lineHeight: 1.5, marginBottom: '1.25rem' }}>
                      Veb-saytlar, Telegram botlar va interfeyslar bo'yicha to'liq integratsiya va dasturlash ishlariga mas'ul yaratuvchi.
                    </p>

                    <button 
                      onClick={() => handleOpenBuyurmaForm()}
                      className="btn btn-primary"
                      style={{ width: '100%', padding: '0.65rem 1.25rem', fontSize: '0.88rem', background: 'linear-gradient(135deg, #38bdf8 0%, #10b981 100%)' }}
                    >
                      <Rocket size={15} /> Bog'lanish / Loyiha berish
                    </button>
                  </div>
